...
<div class="container-fluid">
    <div class="container">
        <nav class="breadcrumb bg-transparent m-0 p-0">
            ...
            <a class="breadcrumb-item active" href="#">Download</a>
        </nav>
    </div>
</div>
<!-- Breadcrumb End -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                        ...
                        <div class="position-relative mb-3">
                            <div class="overlay position-relative bg-light">
                                <div class="mb-2" style="font-size: 14px;">
                                    <span><?= format_tgl($dw->tgl_posting) ?></span>
                                </div>
                                <a class="h4" href="<?=site_url('download/file/'.$dw->id_download.'/'.$dw->nama_file)?>"><?=$dw->judul?></a>
                                <p class="m-0">Telah di unduh <?=$dw->hits?> kali</p>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <?= $pager->links('download', 'pagination'); ?>
                    </div>
                </div>
            </div>
