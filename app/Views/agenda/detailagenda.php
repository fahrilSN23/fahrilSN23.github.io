...
<div class="container-fluid">
    <div class="container">
        <nav class="breadcrumb bg-transparent m-0 p-0">
            ...
            <a class="breadcrumb-item" href="<?=site_url('listagenda')?>">Agenda</a>
            <a class="breadcrumb-item active" href="#"><?=$agenda->tema?></a>
        </nav>
    </div>
</div>
<!-- Breadcrumb End -->
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="position-relative mb-3">
                    <img class="img-fluid w-50 offset-3 mb-3" src="<?=base_url()?>public/template/assets/img/agenda/<?=$agenda->gambar?>">
                    <div class="overlay position-relative bg-light">
                        <div class="mb-3">
                            <span><?=format_tgl($agenda->tgl_posting)?></span>
                        </div>
                        <div>
                            <h3 class="mb-3"><?=$agenda->tema?></h3>
                            <?=$agenda->isi_agenda?>
                        </div>
                    </div>
                </div>
