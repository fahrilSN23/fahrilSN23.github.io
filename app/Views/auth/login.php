...
<head>
  ...
  <title>Login &mdash; BlogKu</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="<?=base_url()?>/public/template/assets/img/avatar/avatar-2.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="mt-5 text-muted text-center">
              Kembali ke halaman utama <a href="<?=site_url()?>">Klik Disini</a>
            </div>
            <div class="simple-footer">
              Copyright &copy; AntCode 2023
            </div>
          </div>
        </div>
      </div>
