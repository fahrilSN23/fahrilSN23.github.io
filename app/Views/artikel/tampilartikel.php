...
<div class="container-fluid">
    <div class="container">
        <nav class="breadcrumb bg-transparent m-0 p-0">
            ...
            <a class="breadcrumb-item active" href="#"><?=$listkat->name_kategori?></a>
        </nav>
    </div>
</div>
<!-- Breadcrumb End -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                            <h3 class="m-0">Artikel <?=$listkat->name_kategori?></h3>
                        </div>
                    </div>
                        ...
                        <div class="position-relative mb-3">
                            ...
                            <div class="overlay position-relative bg-light">
                                <div class="mb-2" style="font-size: 14px;">
                                    <a href="<?=site_url('kategoriartikel/detail/'.$listkat->slug_kategori.'/'.$ar->judul_seo)?>"><?=$ar->email?></a>
                                    <span class="px-1">/</span>
                                    <span><?= format_tgl($ar->tanggal) ?></span>
                                </div>
                                <a class="h4" href="<?=site_url('kategoriartikel/detail/'.$listkat->slug_kategori.'/'.$ar->judul_seo)?>"><?=$ar->judul?></a>
                                <p class="m-0"><?=$isi?>...</p>
                            </div>
                        </div>
                    </div>
