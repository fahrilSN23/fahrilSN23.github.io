...
<?= $this->section('title') ?>
<title>Tambah Video &mdash; BlogKu</title>
<?= $this->endSection() ?>
      ...
      <div class="section-body">
        <div class="card">
          ...
          <div class="card-body col-md-12">
            <form action="<?=site_url('video')?>" method="post" enctype="multipart/form-data" autocomplete="off">
              <?= csrf_field() ?>
	            <div class="form-group row mb-4">
	              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul Video</label>
	              <div class="col-sm-12 col-md-7">
	                <input type="text" name="jdl_video" class="form-control" required>
	              </div>
	            </div>
				<div class="form-group row mb-4">
	              ...
	              <div class="col-sm-12 col-md-7">
					<select name="id_playlist" class="form-control select2" required>
						...
						echo "<option value='$p->id_playlist'>$p->jdl_playlist</option>";
						} ?>
					</select>
	              </div>
	            </div>
