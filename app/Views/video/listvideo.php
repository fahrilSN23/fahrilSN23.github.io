...
<div class="container-fluid">
    <div class="container">
        <nav class="breadcrumb bg-transparent m-0 p-0">
            ...
            <a class="breadcrumb-item active" href="#">Video</a>
        </nav>
    </div>
</div>
<!-- Breadcrumb End -->
                        ...
                        <div class="position-relative mb-3">
                            ...
                            <div class="overlay position-relative bg-light">
                                <div class="mb-2" style="font-size: 14px;">
                                    <a href="<?=site_url('listvideo/detail/'.$vid->playlist_seo.'/'.$vid->video_seo)?>"><?=$vid->email?></a>
                                    <span class="px-1">/</span>
                                    <span><?= format_tgl($vid->tanggal) ?></span>
                                </div>
                                <a class="h4" href="<?=site_url('listvideo/detail/'.$vid->playlist_seo.'/'.$vid->video_seo)?>"><?=$vid->jdl_video?></a>
                                <p class="m-0"><?=$isi?>...</p>
                            </div>
                        </div>
                    </div>
