...
<?= $this->section('title') ?>
<title>Tambah Iklan Sidebar &mdash; BlogKu</title>
<?= $this->endSection() ?>
...
<?= $this->section('content') ?>
    <section class="section">
      <div class="section-header">
        ...
        <h1>Tambah Iklan Sidebar</h1>
      </div>
      
      <div class="section-body">
        <div class="card">
          <div class="card-header">
            <h4>Tambah Iklan Sidebar</h4>
          </div>
          <div class="card-body col-md-12">
            <form action="<?=site_url('iklan_sidebar/save')?>" method="post" enctype="multipart/form-data" autocomplete="off">
              <?= csrf_field() ?>
