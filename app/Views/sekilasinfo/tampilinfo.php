...
<div class="container-fluid">
    <div class="container">
        <nav class="breadcrumb bg-transparent m-0 p-0">
            ...
            <a class="breadcrumb-item active" href="#">Sekilas Info</a>
        </nav>
    </div>
</div>
<!-- Breadcrumb End -->
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="row">
                    ...
                    $info =(strip_tags($in->info)); 
                    $isi = substr($info,0,220); 
                    $isi = substr($info,0,strrpos($isi," "));    
                    ?>
                    <div class="col-lg-4">
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="<?=base_url()?>public/template/assets/img/sekilasinfo/<?=$in->gambar?>" style="object-fit: cover;">
                            <div class="overlay position-relative bg-light">
                                <div class="mb-2" style="font-size: 14px;">
                                    <span><?= format_tgl($in->tgl_posting) ?></span>
                                </div>
                                <a href="<?=site_url('listinfo/detail/'.$in->id_sekilasinfo)?>"><p class="m-0"><?=$isi?>...</p></a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
